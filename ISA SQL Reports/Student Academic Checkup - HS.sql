...
where s.enroll_status = 0 and sgs.gradelevel = s.grade_level and ascore.ismissing = 1 and ascore.isexempt = 0 and s.grade_level in (9,10,11,12) and (pgf.grade in ('1','2','3','4'))
