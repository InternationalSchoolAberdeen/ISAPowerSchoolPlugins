select s.lastfirst as "Student Name", s.grade_level as "Grade", c.course_name as "Course Name", u.lastfirst as "Teacher Name", pgf.grade as "Final Grade", pgf.comment_value as "Final Comment", st.name as "Standard Name", sgs.standardgrade as "Standard Grade"
from cc
